...
import {Button, initTE, Input} from "tw-elements";
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <form onSubmit={login}>
              ...
              <div className="flex flex-row items-center justify-center lg:justify-start">
                <p className="mb-0 mr-4 text-lg">Увійти за допомогою</p>
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                  ...
                  <a href="/registration" className="ml-2 text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
                  >Зареєструватись
                  </a>
                </p>
              </div>
